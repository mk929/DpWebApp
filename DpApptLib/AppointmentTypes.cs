...
namespace DpApptLib
{
        ...
        public static string XmlFileName
        {
            get
            {
                if (string.IsNullOrEmpty(_configXmlFileName))
                    _configXmlFileName = AppDomain.CurrentDomain.BaseDirectory + "AppointmentTypes.xml";
    ...
    public static class Holidays
    {
        ...
        public static string XmlFileName
        {
            ...
            {
                if (string.IsNullOrEmpty(_configXmlFileName))
                    _configXmlFileName = AppDomain.CurrentDomain.BaseDirectory + "Holidays.xml";
                return _configXmlFileName;
            }
        }
