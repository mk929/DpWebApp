...
namespace DpApptLib.Util
{
    ...
    public class Email
    {
        ...
        public static System.Net.Mail.Attachment GetPdfAttachmentFromHtmlString(string htmlContent, MemoryStream pdfStream, string pdfFileName)
        {
            Pdf.WriteHtmlToPdfStream(htmlContent, pdfStream);
            return GetPdfAttachmentFromPdfStream(pdfStream, pdfFileName);
        }

        public static System.Net.Mail.Attachment GetPdfAttachmentFromPdfStream(MemoryStream pdfStream, string pdfFileName)
        {
            ContentType contentType = new ContentType(MediaTypeNames.Application.Pdf);
            var attachment = new System.Net.Mail.Attachment(pdfStream, contentType);
