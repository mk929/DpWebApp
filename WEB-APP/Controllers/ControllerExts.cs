...
namespace DpWebApp.Controllers
{
    public static class ControllerExts
    {
        ...
        public static string GetPartialHtmlViewName(this Controller cntlr, int requesterType)
        {
            string partialHtml = string.Empty;
            switch (requesterType)
            {
                case 1:
                    partialHtml = "_ConsularApptFormAgnt";
                    break;
                case 2:
                    partialHtml = "_ConsularApptFormIndv";
                    break;
                default:
                    partialHtml = "_ConsularApptFormAgnt";
                    break;
        ...
        {
            var consularApptVM = DpWebApp.Models.Data.DpWebAppDb.GetConsularApptById(id);
