...
namespace DpWebApp.Models.Data
{
    public class DpWebAppDb
    {
        ...
        private static SqlConnection GetDBConnection()
        {
            ...
            string connString = DpWebAppConfig.DbConnectionString;
        ...
        private static ConsularApptVM GetConsularApptVM( DataRow dr )
        {
            ...
            {
                ID = dr.Field<int>("Id"),
                RequesterType = dr.Field<int>("RequesterType"),
                ...
                TotalNumberOfApplications = dr.Field<int>("TotalNumberOfApplications"),
